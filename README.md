...
The tracker is organized into categories and displays mods in a clean, easy-to-read interface with pagination for smooth performance.
📊 Features
...
🎮 How to Use
Click the ModInfo+ button in the main menu
Select a category from the top tabs
Browse mods (2 per page)
Use < Prev and Next > to navigate
Hit Refresh to update stats (1-minute cooldown)
Cached stats show countdown until auto-refresh
